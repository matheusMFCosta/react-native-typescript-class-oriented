...
export default function createLogic(wow) {
    ...
    var name = logicOptions.name, type = logicOptions.type, cancelType = logicOptions.cancelType, _logicOptions$warnTim = logicOptions.warnTimeout, warnTimeout = _logicOptions$warnTim === undefined ? 60000 : _logicOptions$warnTim, _logicOptions$latest = logicOptions.latest, latest = _logicOptions$latest === undefined ? false : _logicOptions$latest, _logicOptions$debounc = logicOptions.debounce, debounce = _logicOptions$debounc === undefined ? 0 : _logicOptions$debounc, _logicOptions$throttl = logicOptions.throttle, throttle = _logicOptions$throttl === undefined ? 0 : _logicOptions$throttl, validate = logicOptions.validate, transform = logicOptions.transform, _logicOptions$process = logicOptions.process, process = _logicOptions$process === undefined ? emptyProcess : _logicOptions$process, _logicOptions$process2 = logicOptions.processOptions, processOptions = _logicOptions$process2 === undefined ? {} : _logicOptions$process2;
    if (!type) {
    ...
    if (NODE_ENV !== "production" && typeof processOptions.dispatchMultiple !== "undefined" && warnTimeout !== 0) {
        ...
        console.error("warning: in logic for type(s): " +
            type +
