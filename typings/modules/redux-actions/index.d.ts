...
declare module "redux-actions" {
    ...
    export function createAction<Payload>(actionType: string, payloadCreator: ActionFunction0<Payload>): ActionFunction0<Action<Payload>>;
    ...
    export function createAction<Payload>(actionType: string): ActionFunctionAny<Action<Payload>>;
    ...
    export function handleActions<State, Payload>(reducerMap: ReducerMap<State, Payload>, initialState: State): Reducer<State, Payload>;

    export function combineActions(...actionTypes: Array<ActionFunctions<any>>): Array<ActionFunctions<any>>;
}
